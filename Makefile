...
#             write_debug.c
#
# $Id: Makefile,v 5.10.2.16 2012/02/08 21:31:01 vicadmin Exp $
#
# -----------------------------------------------------------------------
...
CFLAGS  = -I. -pg -O0 -g -ffast-math #-Wall -Wno-unused
#LIBRARY = -lm
...
OBJS =  CalcAerodynamic.o CalcBlowingSnow.o SnowPackEnergyBalance.o \
	...
	water_under_ice.o vic_ensemble.o resample.o Statistics.o vic_ensemble_io.o \
        initialize_atmos_BLUEWATERS.c
...
#model:
#	gcc -c $(EXT) $(OBJS) $(CFLAGS) $(LIBRARY)
#model:
#	gcc -c *.c $(EXT) $(CFLAGS) $(LIBRARY)

#wrapper:
#	gfortran -c vic_ensemble.f90

#VIC_ensemble :
#	gfortran vic_ensemble.o $(OBJS) -o VIC_ensemble.exe
